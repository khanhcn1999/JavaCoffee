...
public class QueryDAO {
    ...
    private MyConnectDAO mycon = new MyConnectDAO();
    public QueryDAO(){
        if(con == null){
            try{
                con = mycon.connect();
...
//Chuong Trinh Khuyen Mai
    ...
    public ArrayList LoadKM(){
        ArrayList<ChuongTrinhKhuyenMaiDTO> dsctkm = new ArrayList<>();
        try{
...
// Chi Tiet Khuyen Mai
    public ArrayList LoadCTKM(){
        ArrayList dskmct = new ArrayList<ChiTietCTKMDTO>();
        try{
            String sql = "Select * from " + tableCTKM;
            PreparedStatement st = con.prepareStatement(sql);
            ResultSet rs = st.executeQuery();
            while(rs.next()){
                ChiTietCTKMDTO kmct = new ChiTietCTKMDTO();
    ...
    public boolean UpdateCTKM(ChiTietCTKMDTO ctkm, String a, String b){
...
// Chi Tiet Hoa Don
    ...
    public boolean UpdateCTHD(ChiTietHDDTO cthd, String a, String b){
...
// Chi Tiet San Pham    
    ...
    public boolean UpdateCTSP(ChiTietSPDTO ctsp, String a, String b){
